...
export default function Dashboard() {
  ...
  return (
    <div className="flex-1 w-full p-4 mt-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-full mx-auto gap-2 mt-4 md:mt-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        <div className="bg-white border border-black/10 rounded-md p-4 space-y-5 shadow-sm">
          ...
          <div className="bg-blue-100 border border-blue-600 rounded-md p-2 flex items-center">
            <div className="w-3/4 text-blue-800">
              <h4 className="text-[15px] font-semibold">completed tasks</h4>
              <p className="text-sm">Here the completed task</p>
            </div>
            <div className="bg-blue-400 rounded-full border border-blue-800 text-white w-1/4 text-center text-xs">
              completed
            </div>
          </div>
          <div className="bg-blue-100 border border-blue-600 rounded-md p-2 flex items-center">
        ...
        <div className="bg-white border border-black/10 rounded-md p-4 space-y-5 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-semibold text-red-600">Completed Tasks</h2>
          </div>
          <div className="bg-red-100 border border-red-600 rounded-md p-2 flex items-center">
            <div className="w-3/4 text-red-800">
              <h4 className="text-[15px] font-semibold">Deleted tasks</h4>
              <p className="text-sm">Here the deleted task</p>
            </div>
            <div className="bg-red-400 rounded-full border border-red-800 text-white w-1/4 text-center text-xs">
              deleted
            </div>
          </div>
          <div className="bg-red-100 border border-red-600 rounded-md p-2 flex items-center">
